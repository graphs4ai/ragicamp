    ...
    def compute(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "datasets library required for Ragas metrics. "
...
def create_ragas_metric(metric_name: str, **kwargs) -> RagasMetricAdapter:
    ...
    try:
        ...
        raise ImportError(
            "ragas library required. Install with: pip install ragas"
        )
    ...
    if metric_name not in metric_map:
        ...
        raise ValueError(
            f"Unknown Ragas metric: {metric_name}. Available: {available}"
        )
